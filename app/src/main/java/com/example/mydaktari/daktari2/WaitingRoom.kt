...
class WaitingRoom : AppCompatActivity() {
    ...
    private lateinit var viewF: Button
    private lateinit var resuM: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewF = findViewById(R.id.Profile)
        resuM = findViewById(R.id.Clerk)
        ...
        viewF.setOnClickListener {
            val intent = Intent(this, ViewFullDescription::class.java)
        ...
        viewD.setOnClickListener {
            val intent = Intent(this, ViewDescription::class.java)
            startActivity(intent)
        }
